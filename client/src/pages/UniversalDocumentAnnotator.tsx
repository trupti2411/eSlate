...
import { Pen, Highlighter, Eraser, Type, RotateCcw, Save, Send, Download } from 'lucide-react';
...
export default function UniversalDocumentAnnotator() {
  ...
  const initializeCanvas = useCallback(() => {
    if (canvasRef.current && containerRef.current) {
      ...
      console.log('Canvas overlay initialized:', rect.width, 'x', rect.height);
    }
  }, []);
  ...
  // Drawing functions with scroll awareness
  const startDrawing = (e: React.MouseEvent<HTMLCanvasElement>) => {
    if (activeTool === 'text' || isScrolling) return;
  ...
  const draw = (e: React.MouseEvent<HTMLCanvasElement>) => {
    if (!isDrawing || activeTool === 'text' || isScrolling) return;
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2">Converting and preparing for annotation...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="bg-white border-b p-4 flex justify-between items-center">
        <h1 className="text-xl font-bold text-gray-800">
          Universal Document Annotation - Assignment {assignmentId}
        </h1>
      ...
      <div className="bg-white border-t p-2 text-sm text-gray-600 flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          {isScrolling && <span className="text-blue-600">Scrolling detected - drawing disabled</span>}
        </div>
        <div className="flex items-center gap-4">
